    ...
    <div className="item-container">
      <div className="item-content">
        ...
        <div className="item-header">
          <button onClick={onBackToStorage} className="back-btn">
        ...
        <div className="selected-storage-display">
          <h2>Storage System: {selectedStorage.name}</h2>
          <p>Game: {selectedStorage.game?.name || 'Unknown Game'}</p>
        </div>
